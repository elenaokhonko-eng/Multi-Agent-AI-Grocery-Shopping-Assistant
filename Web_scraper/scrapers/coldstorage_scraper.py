"""
Cold Storage website scraper implementation.
"""
from typing import Optional, Dict, Any
from scrapers.base_scraper import BaseScraper
from utils.mock_singapore_data import search_mock_products

class ColdStorageScraper(BaseScraper):
    """Scraper for Cold Storage e-commerce website."""
    
    def build_search_url(self, query: str) -> str:
        """Build Cold Storage search URL."""
        return f"https://coldstorage.com.sg/search?q={query}"
    ...
    async def scrape(self, query: str) -> Dict[str, Any]:
        ...
        items = search_mock_products(query, "coldstorage.com.sg")
        if not items:
            return {
                "success": False,
                "items_count": 0,
