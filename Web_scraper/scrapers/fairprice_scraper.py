"""
FairPrice website scraper implementation.
"""
...
class FairPriceScraper(BaseScraper):
    """Scraper for FairPrice e-commerce website."""
    
    def build_search_url(self, query: str) -> str:
        """Build FairPrice search URL."""
        return f"https://www.fairprice.com.sg/search?query={query}"
    ...
    async def scrape(self, query: str) -> Dict[str, Any]:
        ...
        items = search_mock_products(query, "fairprice.com.sg")
        if not items:
            return {
                "success": False,
                "items_count": 0,
