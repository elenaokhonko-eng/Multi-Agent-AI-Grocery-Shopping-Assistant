...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "substitution_policy", sqlmodel.sql.sqltypes.AutoString(), nullable=False, server_default="SAME_BRAND_ONLY"
        ),
    ...
    op.create_index(
        op.f("ix_comparison_snapshots_shopping_list_id"), "comparison_snapshots", ["shopping_list_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_user_product_corrections_shopping_item_name"),
        "user_product_corrections",
        ["shopping_item_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_user_product_corrections_retailer_id"), "user_product_corrections", ["retailer_id"], unique=False
    )
