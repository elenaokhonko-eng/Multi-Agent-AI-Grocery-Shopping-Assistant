...
def calculate_gst_inclusive(gross_total_cents: int, gst_rate_percent: float = 9.0) -> MoneyBreakdown:
    """
    ...
    if gross_total_cents == 0:
        return {"gross_total_cents": 0, "net_cents": 0, "gst_cents": 0, "source_currency": "SGD"}
